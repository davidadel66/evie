...
def freeze(args):
    ...
    write(output / "freeze.json", {
        ...
        "configuration": {"model": "all-minilm:22m", "dimensions": 384,
            ...
            "active_dense_conversation_lexical_candidate_allowance": 24,
            "active_dense_conversation_remaining_candidate_allowance": 40,
            "inactive_dense_lexical_candidate_allowance": 64,
