...
| --- | ---: | ---: | ---: |
| memory-stage5-automatic-reader-v1 | 215 | 591037 | 673 |
...
```sh
python3 -B cmd/evie/docs/fixtures/memory-stage5-automatic-reader/source-preservation/v1/verify-source.py
```
