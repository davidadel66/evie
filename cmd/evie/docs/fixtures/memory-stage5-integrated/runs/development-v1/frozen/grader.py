...
def validate_assessment(assessment, packet, case, row, condition, freeze_sha, packet_sha,
    ...
    return {"errors": errors, "component_hits": component_hits, "citation_hits": citation_hits,
    ...
    for case in cases:
        ...
        for condition in conditions:
            ...
            row = {"case_id": case["id"], "family": case["family"], "condition": condition,
                   ...
                   "citation_denominator": len(required), "assessment_present": path.exists(),
            ...
            try:
                ...
                if row["assessment_valid"]:
                    for key in ("citation_hits", "grounded_propositions", "personal_propositions", "semantic_pass", "unnecessary_clarification"):
                        row[key] = result[key]
