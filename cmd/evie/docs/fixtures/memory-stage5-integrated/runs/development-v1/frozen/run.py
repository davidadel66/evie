...
def seal_release(args):
    ...
    if report.get("freeze_sha256") != sha256(development_path) or (report.get("partition") != "development" or report.get("all_required_gates_pass") is not True):
        raise RuntimeError("verified passing development report must bind this exact freeze")
