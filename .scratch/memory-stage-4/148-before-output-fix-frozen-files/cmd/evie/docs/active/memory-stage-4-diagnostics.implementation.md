...
- Foreground terminal commit measures the actual final no-tool assistant Append,
  ...
  the host's actual final output (SSE turn_done or REPL output handling). They are
  separate measurements; neither is first-token latency. Diagnostic persistence
