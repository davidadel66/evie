...
there are no members of this root in that gap. Live reconciliation records an
excluded selection with reason `no_root_members`, zero selected events and no
